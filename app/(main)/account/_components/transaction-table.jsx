      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex gap-2 flex-nowrap items-center">
          <Select value={typeFilter} onValueChange={(value) => { setTypeFilter(value); setCurrentPage(1); }}>
            ...
            <SelectContent className="select-content-compact">
              <SelectItem value="INCOME" className="select-item text-sm">Income</SelectItem>
              <SelectItem value="EXPENSE" className="select-item text-sm">Expense</SelectItem>
            </SelectContent>
          </Select>
          ...
          <Select value={recurringFilter} onValueChange={(value) => { setRecurringFilter(value); setCurrentPage(1); }}>
            ...
            <SelectContent className="select-content-compact">
              <SelectItem value="recurring" className="select-item text-sm">Recurring Only</SelectItem>
              <SelectItem value="non-recurring" className="select-item text-sm">Non-recurring Only</SelectItem>
            </SelectContent>
          </Select>
                        ...
                        <Tooltip>
                          ...
                          <TooltipContent>
                            <div className="text-sm">
                              ...
                              <div>{transaction.nextRecurringDate ? format(new Date(transaction.nextRecurringDate), "PPP") : "Not set"}</div>
                            </div>
                          </TooltipContent>
                        </Tooltip>
                      </TooltipProvider>
